...
export const moduleManifest: Record<string, () => Promise<ExampleModule>> = {
	...
	backgroundPlasmaShader: () => import('@8f4e/examples/modules/backgroundPlasmaShader').then(m => m.default),
	...
	euclideanRhythm: () => import('@8f4e/examples/modules/euclideanRhythm').then(m => m.default),
	...
	postProcessRippleShader: () => import('@8f4e/examples/modules/postProcessRippleShader').then(m => m.default),
