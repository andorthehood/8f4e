...
| 232 | Re-run init-only modules when default memory values change | 🟡 | 4-6h | 2026-02-18 | On incremental recompiles, rerun all init-only modules after changed defaults are patched, without invoking full `init()` |
