...
const ericSaiteGeneratorCodeBlocks: Project['global'] = [
	{
		code: [
			'config',
			'; @pos -241 -15',
...
const ericSaiteGenerator: Project = {
	global: ericSaiteGeneratorCodeBlocks.filter(block => !block.code[0]?.startsWith('module ')),
	entries: {
		main: ericSaiteGeneratorCodeBlocks.filter(block => block.code[0]?.startsWith('module ')),
	},
};
