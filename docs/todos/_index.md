...
| 347 | Move function name collection and call target validation into semantic prepass | 🟡 | 4-8h | 2026-03-29 | `call` still discovers missing function targets in codegen instead of relying on semantic prepass name collection and validation. |
