...
| 294 | Add editor tab-stop directive support | 🟡 | 1-2d | 2026-03-09 | Add `; @tab <position>` support with literal tab insertion, visual-column mapping, width/caret/render updates, minimum tab advance `1`, and fallback advance `1` when no stop applies |
