...
| 476 | Extract editor render projection | 🟡 | 3-5d | 2026-08-21 | Project render-ready sprite and pixel data from editor state while retaining logical gaps for caret behavior. |
