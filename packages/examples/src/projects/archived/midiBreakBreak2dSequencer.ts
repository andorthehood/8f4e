...
const projectCodeBlocks: Project['global'] = [
	{
		code: [
			'config',
			'; @pos 24 -10',
...
const project: Project = {
	global: projectCodeBlocks.filter(block => !block.code[0]?.startsWith('module ')),
	entries: {
		main: projectCodeBlocks.filter(block => block.code[0]?.startsWith('module ')),
	},
};
