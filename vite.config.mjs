...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      'glugglug': resolve(__dirname, 'packages/editor/packages/glugglug/dist'),
      '@8f4e/compiler': resolve(__dirname, 'packages/compiler/dist'),
      '@8f4e/sprite-generator': resolve(__dirname, 'packages/editor/packages/sprite-generator/dist'),
      '@8f4e/state-manager': resolve(__dirname, 'packages/editor/packages/state-manager/dist'),
