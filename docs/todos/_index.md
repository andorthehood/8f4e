...
| 288 | Refactor directive parsing into shared parser | 🟡 | 1-2d | 2026-02-26 | Introduce a shared parser for `; @...` directives that returns normalized records (`name`, string args, source metadata) and migrate existing directive consumers incrementally |
