...
This package owns bytecode emission, instruction compilers, WASM function bodies, initial memory data segments, memory-import sizing, and final WASM section assembly. It consumes semantic compiler artifacts such as unchanged ASTs, semantic reference reports, namespaces, memory plans, stack reports, and resolved defaults; it does not parse source, resolve semantic references, or decide project-level compiler pass ordering.
