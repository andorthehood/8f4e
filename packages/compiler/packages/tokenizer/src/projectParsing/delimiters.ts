...
export const INCLUDES_BLOCK_DELIMITER = { type: 'includes', opener: 'includes', closer: 'includesEnd' } as const;
...
export const PROJECT_BLOCK_DELIMITERS = [
	...
	{ opener: INCLUDES_BLOCK_DELIMITER.opener, closer: INCLUDES_BLOCK_DELIMITER.closer },
] as const;
