...
| 163 | Web-UI Memory Ref Init And Views | 🟡 | 2-3d | 2026-01-07 | Move web-ui memory access to a stable ref passed into init, creating int/float views internally and threading them into memory-dependent drawers |
