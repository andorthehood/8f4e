...
| 393 | Add MIDI input SPSC editor directive | 🟡 | 1-2d | 2026-05-07 | Add a single `@midiInput` directive that binds a Web MIDI input port id to a raw five-word SPSC buffer in 8f4e memory. |
