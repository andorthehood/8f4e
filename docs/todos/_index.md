...
| 219 | Add favorite code blocks + jump menu navigation | 🟡 | 1-2d | 2026-02-13 | Add `; @favorite` directive support, derived/persisted favorites (`id` + `creationId`), and a `Jump to...` context-menu submenu that recenters the viewport on selected favorites |
