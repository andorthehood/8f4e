...
| 343 | Move arity and raw argument-shape validation into tokenizer | 🟡 | 4-8h | 2026-03-28 | Many instruction compilers still validate argument count and raw argument shape even when those checks depend only on instruction syntax. |
