...
- `npx nx run @8f4e/examples:test`: Test deterministic module generation and verify generated files match saved sources, then run embedded `#test` modules in example `.8f4em` files through the CLI test runner.
