...
| 235 | Add nonstick group override directive and menu actions | 🟡 | 4-8h | 2026-02-16 | Add `; @group <groupName> nonstick` override plus `Make Group Nonstick`/`Make Group Sticky` actions while keeping grouped drag as the default mode |
