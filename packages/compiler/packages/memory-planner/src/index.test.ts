...
function validatedModuleAst(id: string, lineNumber: number, lines: readonly CompilerASTLine[]): ValidatedModuleAST {
	return {
		type: 'module',
		id,
		lines: [moduleLine(id, lineNumber), ...lines],
		moduleLine: moduleLine(id, lineNumber),
		memoryDeclarationLines: [],
