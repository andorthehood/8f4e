...
export const recompileDebounceDelayEditorConfigValidator: EditorConfigValidator = createSchemaEditorConfigValidator({
	root: RECOMPILE_DEBOUNCE_DELAY_CONFIG_PATH,
