...
- CLI does not resolve editor directives such as `@runtime`
...
- Remove `@runtime` and runtime default resolution from CLI config compilation.
...
- `rg -n "compiledProjectConfig|runtimeSettings|@runtime|defaultProjectConfig" packages/cli`
