...
- `packages/editor/packages/glugglugglug/src/index.ts` - Main Engine class modifications
- `packages/editor/packages/glugglugglug/src/utils/createTexture.ts` - May need updates for framebuffer textures
