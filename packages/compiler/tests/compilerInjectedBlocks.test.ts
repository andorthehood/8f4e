...
`,
		...
		const memoryPlan = fixture.compileResult.memoryPlan.modules.injectedPrototypeCaller!;
		const output = memoryPlan.memory.output!.byteAddress;
		const injectedValue = memoryPlan.memory.value!.byteAddress;
