...
| 213 | Support buffer& end address in declaration initializers | 🟡 | 2-4h | 2026-02-08 | Make declaration defaults honor `buffer&` as end address (not start) and align behavior with `push` memory-reference semantics |
