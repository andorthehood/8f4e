...
import { getDataStructure, getElementMaxValue } from '../../../utils/memoryData';
...
export default function pushElementMax(line: AST[number], context: CompilationContext): CompilationContext {
	...
	const maxValue = getElementMaxValue(context.namespace.memory, base);
...
if (import.meta.vitest) {
	...
	describe('pushElementMax', () => {
		it('pushes max value for element type', () => {
