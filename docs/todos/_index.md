...
| ---- | ----- | --------- | ----- |
| 483 | Lazy-load WASM overlay rendering | 2026-09-11 | Deferred the overlay drawer and RGBA layer into an optional chunk, reduced the initial editor bundle by about 2.48 kB gzip, and avoided overlay GPU allocations for projects without the feature. |
