...
| 101 | Use Vitest for Screenshot-Based Visual Regression Testing | 🟡 | 1-2d | 2025-11-24 | Implemented Vitest browser mode with Playwright provider for visual regression tests; created working prototype in @8f4e/web-ui package; established unified testing stack replacing standalone Playwright; screenshots stored in __snapshots__/ with Git LFS; opt-in for CI to control costs |
