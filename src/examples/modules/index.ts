...
export const moduleMetadata: ModuleMetadata[] = [
	{ slug: 'XORShift', title: 'XORShift (Signed, Float, -1 - 1)', category: 'Functions/Random' },
	{ slug: 'amenBreak64Step', title: 'Amen Break 64 Step', category: 'Sequencers/Break Beats' },
	{ slug: 'audioBufferOut', title: 'Audio Buffer Out', category: 'Audio Buffer' },
	{ slug: 'binSwitchesLSb', title: 'Binary Switches (LSb first)', category: 'I/O/Controllers' },
	{ slug: 'binSwitchesMSb', title: 'Binary Switches (MSb first)', category: 'I/O/Controllers' },
	{ slug: 'binaryGateSequencer', title: 'Binary Gate Sequencer', category: 'Sequencers' },
	{ slug: 'binaryShiftRegister', title: 'Binary Shift Register', category: 'Functions/Bitwise' },
	{ slug: 'bitcrusher', title: 'Bitcrusher', category: 'Effects/Audio' },
	{ slug: 'bitwiseAnd', title: 'Bitwise AND', category: 'Functions/Bitwise' },
	{ slug: 'bitwiseOr', title: 'Bitwise OR', category: 'Functions/Bitwise' },
	{ slug: 'bitwiseXor', title: 'Bitwise XOR', category: 'Functions/Bitwise' },
	{ slug: 'bpmClock', title: 'BPM Clock', category: 'Clock' },
	{ slug: 'break16Step1', title: '16 Step Break 1', category: 'Sequencers/Break Beats' },
	{ slug: 'break16Step2', title: '16 Step Break 2', category: 'Sequencers/Break Beats' },
	{ slug: 'bufferCombinerInt', title: 'Buffer Combiner (Int)', category: 'Functions/Buffer' },
	{ slug: 'bufferCombinerIntFloat', title: 'Buffer Combiner (Float)', category: 'Functions/Buffer' },
	{ slug: 'bufferCopierFloat', title: 'Buffer Copier (Float)', category: 'Functions/Buffer' },
	{ slug: 'bufferCopierInt', title: 'Buffer Copier (Int)', category: 'Functions/Buffer' },
	{ slug: 'bufferFloatToInt', title: 'Float Buffer to Int Buffer Converter', category: 'Functions/Buffer' },
	{ slug: 'bufferIntToFloat', title: 'Int Buffer to Float Buffer Converter', category: 'Functions/Buffer' },
	{
	...
	{ slug: 'bufferReverserFloat', title: 'Buffer Reverser (Float)', category: 'Functions/Buffer' },
	{ slug: 'bufferReverserInt', title: 'Buffer Reverser (Int)', category: 'Functions/Buffer' },
	{ slug: 'changeDetectorInt', title: 'Change Detector (Int)', category: 'Functions/Trigger' },
	{ slug: 'clockDivider', title: 'Clock Divider', category: 'Clock' },
	{ slug: 'decToBin8bitMSb', title: 'Decimal to Binary Converter (8bit, MSb)', category: 'Functions/Bitwise' },
	{ slug: 'delay', title: 'Delay', category: 'Effects/Audio' },
	{ slug: 'expLookupTable', title: 'Exponent Function Lookup Table (-1...1)', category: 'Functions/Lookup Tables' },
	{ slug: 'generalMIDIDrumCodes', title: 'General MIDI Drum Codes', category: 'I/O/MIDI' },
	{
		slug: 'linearCongruentialGenerator',
		title: 'Linear Congruential Generator (Signed, Float, 16bit, -1 - 1)',
		category: 'Functions/Random',
	},
	{ slug: 'lowPassFilter', title: 'Low-pass Filter', category: 'Effects/Filters' },
	{ slug: 'mapToRangeFloat', title: 'Map Signal to Range (Float)', category: 'Functions/Utils' },
	{ slug: 'mapToRangeFloatToInt', title: 'Map Signal to Range (Float to Int)', category: 'Functions/Utils' },
