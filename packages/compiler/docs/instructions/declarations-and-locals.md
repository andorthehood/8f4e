...
The compiler may encode these initializer values sparsely in WebAssembly passive data segments; this does not change the runtime memory image after `initDefaults()`.
