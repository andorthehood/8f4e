...
| 348 | Add viewport-anchored code block directive | 🟡 | 4-8h | 2026-03-29 | The editor currently supports only world-space block positioning through `@pos`, which makes it awkward to pin HUD-style blocks to a viewport corner while keeping them safely visible and editable. |
