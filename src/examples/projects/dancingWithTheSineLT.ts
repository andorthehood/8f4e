...
const project: Project = {
	...
	codeBlocks: [
		...
		},
		{
			...
			gridCoordinates: { x: 89, y: -12 },
		},
	],
	viewport: { gridCoordinates: { x: -71, y: -23 } },
	selectedRuntime: 0,
	runtimeSettings: [
		{
			sampleRate: 50,
