...
const defaultColorScheme: ColorScheme = {
	text: {
		lineNumber: 'rgba(51,51,51,1)',
		instruction: 'rgba(136,126,203,1)',
		codeComment: 'rgba(102,102,102,1)',
		code: 'rgba(255,255,255,1)',
		disabledCode: 'rgba(0,0,0,0.5)',
		numbers: 'rgba(201,212,135,1)',
		menuItemText: 'rgba(255,255,255,1)',
		menuItemTextHighlighted: 'rgba(0,0,0,1)',
		dialogText: '#ffffff',
		dialogTitle: '#ffffff',
		binaryZero: 'rgba(201,212,135,1)',
		binaryOne: 'rgba(201,212,135,1)',
	},
	fill: {
		menuItemBackground: 'rgba(0,0,0,1)',
		menuItemBackgroundHighlighted: 'rgba(255,255,255,1)',
		background: '#000000',
		backgroundDots: '#444444',
		backgroundDots2: '#444444',
		moduleBackground: '#000000',
		moduleBackgroundDragged: 'rgba(0,0,0,0.8)',
		moduleBackgroundDisabled: 'rgba(0,0,0,0.1)',
		wire: '#ffffff',
